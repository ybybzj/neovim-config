...
let g:far#file_mask_favorites=['%:p', 'src/**/*.*', '**/*.js', '**/*.py', '**/*.java', '**/*.css', '**/*.html', '**/*.vim', '**/*.cpp', '**/*.c', '**/*.h', ]
let g:far#window_min_content_width=30
let g:far#enable_undo=1
let g:far#auto_preview=0
let g:far#collapse_result=1
let g:far#mode_open={"regex": 0, "case_sensitive": 1, "word": 1, "substitutes": 0}
...
map <leader>f :F %w % --source=rgnvim --case-sensitive=1 --word-boundary=1 --regex=0
map <leader>fc :F %w %%**/*.* --source=rgnvim --case-sensitive=1 --word-boundary=1 --regex=0
map <leader>fp :F %w src/**/*.* --source=rgnvim --case-sensitive=1 --word-boundary=1 --regex=0
